      ...
      if(element.likedBy.length > 2) {
        notificationsList.add(Column(
          children: [
            ...
            individualPostWidget(postHeaderInfo: element),
            Divider(thickness: 1)
          ],
        )
        );
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: <Widget> [
          ...
          Divider(thickness: 1),
          Column(
            children: generateNotifications(postNotifications),
          )
