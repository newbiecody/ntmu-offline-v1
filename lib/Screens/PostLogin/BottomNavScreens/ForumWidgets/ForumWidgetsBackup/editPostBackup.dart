...
class EditPostState extends State<EditPost> {
  ...
  final mainContentFieldController = TextEditingController(text: initialMainContentString);
  void initState() {
    super.initState();
    mainContentFieldController.addListener(() {
      final String text = initialMainContentString;
        ...
        appBar: AppBar(
          actions: <Widget>[
            IconButton(onPressed: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (context) =>(PostPreview(postData: generatePostDataPacket(widget.postInfo, mainContentFieldController.text)))));
            },
