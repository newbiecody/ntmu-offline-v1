...
import '../../../../api_functions/getForumPosts.dart';
      ...
      child: Column(
        children: <Widget>[
          ...
          ListView.builder(
            ...
            itemCount: ForumPosts.posts.length,
            shrinkWrap: true,
            itemBuilder: (context, index) {
              return GestureDetector(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) =>(OpenForumThread(individualPost: ForumPosts.posts[index], username: widget.userData.name!))));
                },
                child: Container(
                  child: Padding(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: Text('${ForumPosts.posts[index].originalPoster} - ${timeFromNow(ForumPosts.posts[index].timeOfPost)}',
                                style: TextStyle(
                                  fontSize: 12
                                ),
                                )
                        ...
                        Text(ForumPosts.posts[index].headerContent,
                          style: TextStyle(
                            fontSize: 16
                          ),
                        ),
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  ...
                                  // Text(ForumPosts.posts[index].likedBy.length.toString()),
                                  // IconButton(
                                  //     onPressed: (){},
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    SizedBox(width: 8.0),
                                    Text(ForumPosts.posts[index].comments.length.toString())
                                  ]
                                ),
                              )
                            ],
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Wrap(
                              spacing: 16,
                              runSpacing: 8,
                              children: generateTags(ForumPosts.posts[index].tags),
                            ),
                          ),
                        ),
                        Divider(thickness: 1)
